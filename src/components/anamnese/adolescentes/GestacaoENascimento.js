...
export default function GestacaoNascimento( { setDados } ) {
    const [dados, setDadosLocal] = useState({
        ...
        intercorrenciaSelecionada: [1],
        qualIntercorrencia: '',
        medicamentoSelecionado: [1],
        partoSelecionado: [
        ...
        quinto: '',
        comprimento: '',
        problemaSelecionado: [1],
        oxigenioSelecionado: [1],
        cianoticoSelecionado: [1],
        chorouSelecionado: [0],
        ictericiaSelecionada: [1],
        fototerapiaSelecionado: [1]
    })
